...
public class MultiModelMap extends ArrayList<LinkedHashMap<String, Object>> {
    ...
    // ClassCastException
    public List<ModelMap> get(Object key) {
    ...
    public List<ModelMap> toListData() {
        List<ModelMap> listData = new ArrayList<ModelMap>();
        for (LinkedHashMap<String, Object> map : this) {
            listData.add(new ModelMap(map));
        }
        return listData;
    }

    public void addMMap(ModelMap Data) {
        add(new ModelMap(Data));
    }
...
//
    ...
    public ModelMap getData(int key) {
        Object obj = get(key);
    ...
    public void addMultiModelMap(MultiModelMap Data) {
        int cnt = Data.size();
        for (int i = 0; i < cnt; i++) {
            this.add(new ModelMap(Data.get(i)));
        }
    }

    public void addMultiDataNoClone(MultiModelMap multiModelMap) {
        int cnt = multiModelMap.size();
        for (int i = 0; i < cnt; i++) {
            this.add(multiModelMap.get(i));
        }
    }

    public void addDataNoClone(ModelMap data) {
        add(data);
    }
