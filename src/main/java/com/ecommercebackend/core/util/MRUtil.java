package com.ecommercebackend.core.util;
...
public class MRUtil extends StringUtils {
     ...
     */
    public static void NVL(ModelMap input) {
        NVL(input, SPACE);
    }
     ...
     */
    public static void NVL(ModelMap input, String defaultStr) {
        if (input != null) {
...
//        return MRNullUtil.isNone( result );
     ...
     * @fullPath
     */
    public static MultiModelMap convertToMultiLine(String str, int length) {

        MultiModelMap outputData = new MultiModelMap();

        if (str.length() <= length) {

            ModelMap line = new ModelMap();
            ...
            do {
                ...
                if (tobeString.length() <= length) {
                    ModelMap lastLine = new ModelMap();
