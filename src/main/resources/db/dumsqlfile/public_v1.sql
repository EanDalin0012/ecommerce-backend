...
CREATE TABLE "public"."personal_information_details" (
  "family_information_id" int4,
  "personal_information_id" int4 NOT NULL,
  "emergency_contact_id" int4,
  "id" int4 NOT NULL
)
;
...
SELECT setval('"public"."authority_id_seq"', 5, false);
...
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."sequence_product"', 31, true);
...
SELECT setval('"public"."success_login_id_seq"', 101, true);
...
-- ----------------------------
-- Primary Key structure for table personal_information_details
-- ----------------------------
ALTER TABLE "public"."personal_information_details" ADD CONSTRAINT "personal_information_details_pkey" PRIMARY KEY ("id");
